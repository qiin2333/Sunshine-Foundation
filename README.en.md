...
[![Simplified Chinese](https://img.shields.io/badge/简体中文-README.zh--CN.md-red?style=for-the-badge)](README.md)
...
- **Remote Microphone** - Supports receiving client microphone input, providing high-quality voice passthrough
...
- **Smart Pairing** - Intelligently manages pairing devices and their corresponding configuration profiles
...
For the best streaming experience (activating set attributes), it is recommended to use the following optimized Moonlight clients:
