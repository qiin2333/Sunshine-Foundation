...
- **Niedrige Latenz** - Optimierte Kodierung unter Nutzung moderner Hardware
- **Intelligente Paarung** - Automatische Verwaltung von Geräteprofilen

### 🖥️ Virtuelle Display-Integration (erfordert Win10 22H2 oder neuer)
...
### 📱 Android-Clients
[![Verstärkte Version Moonlight-Android](https://img.shields.io/badge/Verstärkte_Version-Moonlight--Android-green?style=for-the-badge&logo=android)](https://github.com/qiin2333/moonlight-android/releases/tag/shortcut)
[![Kronen-Version Moonlight-Android](https://img.shields.io/badge/Kronen_Version-Moonlight--Android-blue?style=for-the-badge&logo=android)](https://github.com/WACrown/moonlight-android)

### 📱 iOS-Clients
[![Echte Experten-Version Moonlight-iOS](https://img.shields.io/badge/Echte_Experten_Version-Moonlight--iOS-lightgrey?style=for-the-badge&logo=apple)](https://github.com/TrueZhuangJia/moonlight-ios-NativeMultiTouchPassthrough)
...
<table>
    ...
    <tr>
        <td>Nvidia: NVENC-fähige Grafikkarte, siehe: <a href="https://developer.nvidia.com/video-encode-and-decode-gpu-support-matrix-new">NVENC Unterstützungsmatrix</a></td>
    </tr>
    <tr>
        <td rowspan="2">CPU</td>
    ...
    <tr>
        ...
        <td>Windows: 10 22H2+ (Windows Server unterstützt keine virtuellen Gamecontroller)</td>
    </tr>
    <tr>
        <td>macOS: 12+</td>
    </tr>
...
- `config-help` - Konfigurationsfragen
