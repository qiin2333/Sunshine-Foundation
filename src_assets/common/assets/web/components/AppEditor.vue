      ...
      <div class="modal-content">
              ...
              <div class="accordion-item">
                ...
                <div id="commandsCollapse" class="accordion-collapse collapse" aria-labelledby="commandsHeading" data-bs-parent="#appFormAccordion">
                  <div class="accordion-body">
                    <!-- 全局准备命令 -->
                    <div class="form-group-enhanced">
                      <label for="excludeGlobalPrep" class="form-label-enhanced">{{ $t('apps.global_prep_name') }}</label>
                      <select id="excludeGlobalPrep" class="form-select form-control-enhanced" v-model="formData['exclude-global-prep-cmd']">
                        <option :value="false">{{ $t('_common.enabled') }}</option>
                        <option :value="true">{{ $t('_common.disabled') }}</option>
                      </select>
        ...
        <div class="modal-footer modal-footer-enhanced">
          ...
          <div>
            ...
            <button type="button" class="btn btn-primary" @click="saveApp" :disabled="!isFormValid">
